...
<style>
:root {{
  --bg: #14181a; --surface: #1c2224; --text: #ece4d3; --text-dim: #97a19d;
  --accent: #c9973f; --line: #3a4245; --line-strong: #4d5659;
}}
:root[data-theme="light"] {{
  --bg: #eeece2; --surface: #ffffff; --text: #201d16; --text-dim: #6b6858;
...
def main():
    ...
    xml, info = build_musicxml(notes_path, audio_path, title, override_bpm=override_bpm)
